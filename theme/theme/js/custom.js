$(document).ready(function () {
    ...
    $(".minim_chat_window").click(function(){
        $(".box-message").css("visibility", "collapse");
        $(".sendmess").css("visibility", "collapse");
        $(".boxchat").css("height", "6%");
        $(".minim_chat_window").css("visibility", "collapse");
        $(".show_chat_window").css("visibility", "visible");
    });
    // show box chat xuong
    $(".show_chat_window").click(function(){
        $(".box-message").css("visibility", "visible");
        $(".sendmess").css("visibility", "visible");
        $(".boxchat").css("height", "50%");
        $(".show_chat_window").css("visibility", "collapse");
        $(".minim_chat_window").css("visibility", "visible"); 
    });
